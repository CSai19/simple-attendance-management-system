...
<header>
   <h1 style="font-size:60px; color: #ff0000 " ><center>HOD Login</center></h1>
</header>
...
<div class="login-page" style="text-align:center;">
  <div class="form">
      <form class="login-form" action="hodcheck.php" method="POST">
      <input type="text" placeholder="username" name="husername" required /><br><br>
