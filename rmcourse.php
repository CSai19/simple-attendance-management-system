...
<title>Remove Course</title>
  ...
  <form style="text-align: center;" action="rmcourseaction.php" method="POST">

      <h1 style="text-align: center;"> Remove Course</h1>
    
    <input type="text"  name="cid" placeholder="Course ID" required> <br><br>
