...
<header>
   <h1 style="font-size:60px;" ><center>Student Unenrollment</center></h1>
</header>
...
<div class="login-page" style="text-align:center;">
  <div class="form">
      <form class="login-form" action="unenrollstudentsaction.php" method="POST">
      ...
      <input type="submit" value="Unenroll"><br>
       <br><br>
