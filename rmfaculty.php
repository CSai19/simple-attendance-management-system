...
<title>Remove Faculty</title>
  ...
  <form style="text-align: center;" action="rmfacultyaction.php" method="POST">

      <h1 style="text-align: center;"> Remove Faculty</h1>
    
    <input type="text"  name="fid" placeholder="Faculty ID" required> <br><br>
