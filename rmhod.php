...
<title>Remove HOD</title>
  ...
  <form style="text-align: center;" action="rmhodaction.php" method="POST">

      <h1 style="text-align: center;"> Remove HOD</h1>
    
    <input type="text"  name="hodid" placeholder="HOD ID" required> <br><br>
...
-->
    ...
    <input type="submit" value="Remove HOD">
